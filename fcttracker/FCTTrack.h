...
class FCTTrackExt : public o2::mft::TrackMFT
{
 ...
 public:
  ...
  Int_t getTrackPid() const { return mTrackPid; }
  void setTrackPid(Int_t pid) { mTrackPid = pid; }
  Int_t getProdProcess() { return mProdProcess; }
  void setProdProcess(Int_t prod) {mProdProcess = prod; }
